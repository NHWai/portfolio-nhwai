...
function Homesvg() {
  return (
    <svg
      className="topography-shape js-shape homesvg homesvgtop"
      viewBox="0 0 1200 580"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
      xmlnssvgjs="http://www.w3.org/1999/xlink"
    >
      <path
      ...
      <path
        ...
        // style="position: relative; z-index: 0; fill: rgb(199, 225, 243);"
        style={{
          position: "relative",
          zIndex: 0,
      ...
      <path
        ...
        // style="position: relative; z-index: 1; fill: rgb(184, 207, 230);"
        style={{
          position: "relative",
          zIndex: 1,
          fill: " rgb(199, 225, 243)",
      ...
      <path
        ...
        // style="position: relative; z-index: 2; fill: rgb(169, 190, 218);"
        style={{
          position: "relative",
          zIndex: 2,
          fill: " rgb(199, 225, 243)",
      ...
      <path
        ...
        // style="position: relative; z-index: 3; fill: rgb(154, 173, 206);"
        style={{
          position: "relative",
          zIndex: 3,
          fill: " rgb(199, 225, 243)",
      ...
      <path
        ...
        // style="position: relative; z-index: 4; fill: rgb(139, 155, 193);"
        style={{
          position: "relative",
          zIndex: 4,
          fill: " rgb(199, 225, 243)",
      ...
      <path
        ...
        // style="position: relative; z-index: 5; fill: rgb(125, 138, 181);"
        style={{
          position: "relative",
          zIndex: 5,
          fill: " rgb(199, 225, 243)",
      ...
      <path
        ...
        // style="position: relative; z-index: 6; fill: rgb(110, 121, 169);"
        style={{
          position: "relative",
          zIndex: 6,
          fill: " rgb(199, 225, 243)",
      ...
      <path
        ...
        // style="position: relative; z-index: 7; fill: rgb(95, 103, 156);"
        style={{
          position: "relative",
          zIndex: 7,
          fill: " rgb(199, 225, 243)",
      ...
      {/* <path
        ...
        // style="position: relative; z-index: 10; fill: rgb(50, 51, 119);"
        style={{
          position: "relative",
          zIndex: 10,
          fill: " #38AEE6",
